##///
##||| 2DMAP/NUBE.PY TITANIUM
##||| Change list:
##||| * Cloud animation now plays at 60fps rather than 20fps
##\\\ 
...
def CreaNuve():
	...
	o.SelfIlum    = 1
	o.Alpha       = whrandom.random()/0.6
	o.Data        = whrandom.randint(-250,-50)     # Was -500/-100  -LeadHead
	return o
...
char.SubscribeToList("Timer60")     # Was "Timer30" -LeadHead
