##///
##||| VOLCANO_M14/ActorsInit.PY TITANIUM
##||| Change list:
##||| * Removed non-existant anim to stop throwing errors and stuff.
##\\\ 

Bladex.LoadSampledAnimation("../../Anm/Sct_cae.BMV","Sct_cae",1,"SectorVolcan")
# Bladex.LoadSampledAnimation("../../Anm/Sct_ondula.BMV","Sct_ondula",1,"SectorVolcan")         # Does not exist.
