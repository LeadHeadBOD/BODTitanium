...
Sparks.SetMetalSparkling("reja10")
Sparks.SetMetalSparkling("reja11")
...
Sparks.SetMetalSparkling("rastrillo3")
#Sparks.SetMetalSparkling("rastrillo4")
Sparks.SetMetalSparkling("rastrillo5")
Sparks.SetMetalSparkling("rastrillo6")

#Sparks.SetMetalSparkling("dcandelabro1")

Sparks.SetStoneSparkling("LAPI1")
Sparks.SetStoneSparkling("LAPI2")
Sparks.SetStoneSparkling("LAPI3")
Sparks.SetStoneSparkling("LAPI4")
Sparks.SetStoneSparkling("LAPI5")
Sparks.SetStoneSparkling("LAPI6")
