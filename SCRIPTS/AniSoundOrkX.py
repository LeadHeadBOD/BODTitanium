...
InsultoOrk=Bladex.CreateSound('../../sounds/esfuerzo-orco-golpe-cabeza.wav', 'InsultoOrk')
InsultoOrk.SendNotify=1
InsultoOrk.MinDistance=1000
InsultoOrk.MaxDistance=28000
