...
def AsignarSonidosLich(Personaje):
	...
	per.AddAnimSound('Lch_dth0', CaidaLch1, 0.7950)             #Added -LeadHead
	per.AddAnimSound('Lch_dth0', CaidaLch2, 0.9000)             #
	...
	per.AddAnimSound("Lch_dth_n00", CaidaLch2, 0.7700)          #Added -LeadHead
	per.AddAnimSound("Lch_dth_n00", CaidaLch1, 0.8900)          #Changed (was 0.8)
